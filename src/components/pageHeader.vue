    ...
    <nav class="main-nav main-nav--closed">
      ...
      <div class="main-nav__wrapper">
        <a class="main-nav__logo">
          <img src="../assets/img/logo.svg" width="130" height="55" alt="Logo">
        </a>
        ...
        <ul class="main-nav__list user-list">
          <li class="user-list__item">
            <a href="login.html" class="user-list__login">
              <svg class="user-list__login-icon"
                   xmlns="http://www.w3.org/2000/svg"
                   width="16px"
                   height="16px"
                   viewBox="0 0 500 500">
                <path d="M454.426,392.582c-5.439-16.32-15.298-32.782-29.839-42.362c-27.979-18.572-60.578-28.479-92.099-39.085
